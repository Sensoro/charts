...
var genDefaultConfig = function genDefaultConfig(_ref) {
  ...
  return {
    ...
    group: _objectSpread(_objectSpread({}, getDefaultConfig({
      tooltip: true,
      colorMap: colorMap,
    ...
    bidirection: _objectSpread(_objectSpread({}, getDefaultConfig({
      tooltip: true,
      colorMap: colorMap,
      seriesField: seriesField,
      customContentData: customContentData
...
var Column = function Column(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    colorMap: colorMap,
    timeRange: timeRange
  }, /*#__PURE__*/React.createElement(BaseColumn, newConfig)));
};

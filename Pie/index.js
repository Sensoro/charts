...
var genDefaultConfig = function genDefaultConfig(_ref) {
  ...
  return {
    pie: _objectSpread(_objectSpread({}, getDefaultConfig({
      pie: true,
      tooltipBox: true,
      colorMap: colorMap,
    ...
    ring: _objectSpread(_objectSpread({}, getDefaultConfig({
      pie: true,
      ring: true,
      tooltipBox: true,
      colorMap: colorMap,
...
var Pie = function Pie(_ref2) {
  ...
  var legendMap = useMemo(function () {
    return colorField ? groupBy(originalData, colorField) : {};
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    colorMap: colorMap,
    timeRange: timeRange
  }, /*#__PURE__*/React.createElement(BasePie, newConfig)));
};
export default Pie;